...
\newcommand{\SJTUThesis}{\textsc{WUSTThesis}}
...
\subject{武汉科技大学}
\keywords{LaTeX, 论文排版, WUST Thesis}

\title[\WUSTBeamer 示例文档] % 页脚显示标题
...
%设置WUST校徽
\logo{\includegraphics[height=1cm]{vi/WUST-logo.pdf}}

%设置WUST青山绿配色
\definecolor{cprimary}{RGB}{15,107,31}         % problue
\definecolor{csecondary}{RGB}{153,230,230}      % lightgreen
